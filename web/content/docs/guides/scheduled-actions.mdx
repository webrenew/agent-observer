...
description: Configure cron-based recurring prompts in Agent Space with validation, safety, and failure recovery guidance.
---
...
Agent Space uses a 5-field cron format:
