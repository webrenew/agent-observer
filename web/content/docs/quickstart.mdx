---
title: Quickstart
description: Install Agent Space, open your first workspace, and run your first production-safe agent workflow.
---
...
2. Open the `.dmg`.
3. Drag **Agent Space** into `Applications`.
...
Before using Agent Space for long unattended runs:
