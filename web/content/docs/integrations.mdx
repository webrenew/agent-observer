---
title: Integrations
description: How Agent Space integrates with local tools, agent runtimes, and external runner commands.
---

# Integrations

Agent Space is designed to integrate with local-first development tooling rather than replacing it.
...
Agent Space can orchestrate agent runtime behavior through its desktop runtime layer.
...
- Agent Space Todo Runner for orchestration/progress state
