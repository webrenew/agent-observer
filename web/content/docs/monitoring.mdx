---
title: Monitoring
description: Monitor runtime state, automation health, and execution reliability in Agent Space.
---

# Monitoring

Agent Space exposes runtime state so operators can detect failures quickly and keep long-running work healthy.
