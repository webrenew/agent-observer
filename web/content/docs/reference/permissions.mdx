---
title: Permissions
description: macOS privacy and filesystem permissions required for reliable Agent Space operation.
---

# Permissions

Agent Space depends on local filesystem access to provide workspace-scoped workflows.
...
Check relevant categories and ensure Agent Space is allowed for the intended directories.
