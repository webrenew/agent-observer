---
title: Architecture
description: Technical architecture of Agent Space across desktop runtime, renderer, automation engines, and docs web surface.
---

# Architecture

Agent Space is primarily an Electron desktop application with a separate Next.js documentation/product web surface.
