...
const DEMO_AGENT_POOL: Agent[] = [
  {
    ...
    appearance: { shirtColor: '#4fa3f7', hairColor: '#3b2f1e', hairStyle: 'short', skinTone: '#ffdbb4', pantsColor: '#1e293b', gender: 'masculine' },
  ...
  },
  {
    ...
    appearance: { shirtColor: '#a78bfa', hairColor: '#1a1a2e', hairStyle: 'long', skinTone: '#8d5524', pantsColor: '#4a5568', gender: 'feminine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
  {
    ...
    appearance: { shirtColor: '#fb923c', hairColor: '#c0392b', hairStyle: 'ponytail', skinTone: '#f5c6a0', pantsColor: '#3f3f46', gender: 'feminine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
  {
    ...
    appearance: { shirtColor: '#22d3ee', hairColor: '#d4a574', hairStyle: 'buzz', skinTone: '#d4a373', pantsColor: '#1e3a5f', gender: 'masculine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
  {
    ...
    appearance: { shirtColor: '#4ade80', hairColor: '#8b4513', hairStyle: 'mohawk', skinTone: '#ffdbb4', pantsColor: '#4a3728', gender: 'masculine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
  {
    ...
    appearance: { shirtColor: '#e879f9', hairColor: '#1a1a2e', hairStyle: 'short', skinTone: '#6b3e26', pantsColor: '#2d2d44', gender: 'feminine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
  {
    ...
    appearance: { shirtColor: '#f87171', hairColor: '#e8e0d4', hairStyle: 'long', skinTone: '#a67b5b', pantsColor: '#1e293b', gender: 'masculine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
  {
    ...
    appearance: { shirtColor: '#facc15', hairColor: '#d4a574', hairStyle: 'ponytail', skinTone: '#f5c6a0', pantsColor: '#4a5568', gender: 'feminine' },
    activeCelebration: null,
    celebrationStartedAt: null,
  },
]
