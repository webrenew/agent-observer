...
export const SKY_ZENITH_NIGHT = new Color('#070B15')

/** Horizon band */
export const SKY_HORIZON_DAY = new Color('#B0D4F1')
export const SKY_HORIZON_NIGHT = new Color('#0E1428')
...
export const SKY_GROUND_NIGHT = new Color('#12091E')
...
export const FOG_NIGHT_COLOR = new Color('#1A1A3E')
export const FOG_DENSITY_DAY = 0.006
export const FOG_DENSITY_NIGHT = 0.012
